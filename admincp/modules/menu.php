...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto" style=" text-transform: uppercase;">
            ...
            <li class="nav-item"><a class="nav-link" href="index.php?quanly=thongke&amp;ac=lietke">Quản lý hóa đơn</a></li>
...
<form action="index.php?quanly=timkiem&ac=sp" method="post" class="form-inline my-2 my-lg-0">
